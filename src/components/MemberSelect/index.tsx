...
const MemberSelect: React.FC<MemberSelectProps> = ({
  ...
  const debouncedSearch = useMemo(
    () => (onSearchContentChange ? debounce(onSearchContentChange, 300) : undefined),
    [onSearchContentChange]
  );
  ...
  return (
    <>
      <Select
        ...
        className={`member-select w-full ${isReadOnly ? 'member-select-readonly' : ''} ${className || ''}`}
        style={style}
        tagRender={tagRender}
      ...
      <style>{`
        ...
        .member-select:not(.member-select-readonly).ant-select-focused .ant-select-selector {
          border-color: #2f54eb !important;
          box-shadow: 0 0 0 2px rgba(47, 84, 235, 0.1) !important;
        }
        .member-select-readonly .ant-select-selector {
          cursor: default !important;
          background-color: #fafafa !important;
        }
        .member-select-readonly .ant-select-selection-item {
          cursor: default !important;
        }
